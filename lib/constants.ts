...
export const portfolioProjects = [
  ...
  },
  {
    ...
    iconLucide: "House",
    summary: "Modern interior design portfolio and inquiry platform with elegant project showcases, service sections, and client-focused contact experience.",
    timeline: "Completed",
    stack: "Web, Portfolio, UI/UX",
    challenge:
      "Eleve Interior needed a premium digital presence to showcase design quality, services, and completed spaces in a clear and engaging way.",
    solution:
      "A clean, high-end website with structured service presentation, curated project highlights, and a smooth inquiry flow for potential clients.",
    impact: "Stronger brand positioning and improved lead generation through a polished portfolio-driven web experience.",
  },
  {
    slug: "onmart",
    name: "OnMart",
